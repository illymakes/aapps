document.addEventListener("DOMContentLoaded", function () {
    ...
    async function updateCards(category) {
        ...
        await fetchAndDisplayCards("aapps/json/app-info-compl.json", category);
        await fetchAndDisplayCards("aapps/json/app-info-rese.json", category);
        await fetchAndDisplayCards("aapps/json/app-info-que.json", category);
        await fetchAndDisplayCards("aapps/json/app-info-cnoo.json", category);
        await fetchAndDisplayCards("aapps/json/app-info-other.json", category);
        await fetchAndDisplayCards("aapps/json/app-info-cod.json", category);
        await fetchAndDisplayCards("aapps/json/app-info-tice.json", category);
        await fetchAndDisplayCards("aapps/json/app-info-tra.json", category);
